  ...
  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    >
      ...
      <div class="p-6">
        ...
        <p class="text-gray-600 mb-4">
          Learn how to quickly set up and use TailwindCSS in your next web
          project. Master the utility-first approach...
        </p>
    ...
    >
      ...
      <div class="p-6">
        <div class="flex items-center mb-3">
          <img
            src="https://picsum.photos/32/32?random=6"
            alt="Author"
            class="w-8 h-8 rounded-full mr-3"
          />
          <span
        ...
        <p class="text-gray-600 mb-4">
          Discover essential design principles that will help you create more
    ...
    >
      ...
      <div class="p-6">
        <div class="flex items-center mb-3">
          <img
            src="https://picsum.photos/32/32?random=8"
            alt="Author"
            class="w-8 h-8 rounded-full mr-3"
          />
          <span
        ...
        <p class="text-gray-600 mb-4">
          Learn essential security practices to protect your web applications
          from common vulnerabilities and threats...
        </p>
        <div class="flex items-center justify-between">
    ...
    >
      ...
      <div class="p-6">
        ...
        <p class="text-gray-600 mb-4">
          Master the art of creating responsive websites that work flawlessly
    ...
    >
      ...
      <div class="p-6">
        <div class="flex items-center mb-3">
          <img
            src="https://picsum.photos/32/32?random=12"
            alt="Author"
            class="w-8 h-8 rounded-full mr-3"
          />
          <span
        ...
        <p class="text-gray-600 mb-4">
          Discover techniques and tools to optimize your website's performance
